                    ...
                    <div class="form-group">
                        ...
                        <asp:Label ID="Label1"  CssClass =" col-md-2 control-label" runat="server" Text="BrandName"></asp:Label>
                            <div class="col-md-3">
                                ...
                                <asp:RequiredFieldValidator ID="RequiredFieldValidatorBrandName" runat="server" CssClass="text-danger" ErrorMessage="Input Brandname" ForeColor="Red" ControlToValidate="txtBrand"></asp:RequiredFieldValidator>
                            </div>
